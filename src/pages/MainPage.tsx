...
//     const [filterOption, setFilterOption] = useState<string>('currentMonth'); // Устанавливаем по умолчанию 'currentMonth'
...
//         // Здесь можно обновить состояние для пользовательского периода, если нужно
...
//     return (
//         <>
//             <Header sortOption={sortOption} filterOption={filterOption} onFilterChange={handleFilterChange} onCustomPeriodSelect={handleCustomPeriodSelect} />
//             <div className="main-content">
//                 <Sidebar userRole={currentUser.role} onSortByDate={handleSortByDate} onSortByDirection={handleSortByDirection} />
//                 <main className="content">
//                     <Routes>
//                         <Route path="/" element={<Dashboard />} />
//                         <Route path="/department-statistics" element={<DepartmentStats sortOption={sortOption} filterOption={filterOption} viewType="date" />} />
//                         <Route path="/employee-statistics" element={<EmployeeStats sortOption={sortOption} filterOption={filterOption} />} />
...
// const MainPage = () => {
//     const [sortOption, setSortOption] = useState<'date' | 'direction' | null>('date'); // 'date' по умолчанию
...
//                     <Routes>
//                         <Route path="/" element={<Dashboard />} />
//                         <Route path="/department-statistics" element={<DepartmentStats sortOption={sortOption} filterOption={filterOption} viewType={sortOption || 'date'} />} />
//                         <Route path="/employee-statistics" element={<EmployeeStats sortOption={sortOption} filterOption={filterOption} viewType={sortOption || 'date'} />} />
//                         <Route path="/goals" element={<Goals />} />
//                         <Route path="/achievements" element={<Achievements />} />
//                         <Route path="/lk/statistics-management" element={<StatisticsManagement />} />
//                         <Route path="/lk/data-entry" element={<DataEntry />} />
...
const MainPage = () => {
    ...
    return (
        <>
            ...
            <div className="main-content">
                <Sidebar userRole={currentUser.role} onSortByDate={viewType => handleSortChange(viewType, 'date')} onSortByDirection={viewType => handleSortChange(viewType, 'direction')} />
                <main className="content">
                    <Routes>
                        <Route path="/" element={<Dashboard />} />
